  ...
  return (
    <div className="w-96 flex flex-col gap-3   mt-4 p-7 bg-white rounded-md shadow-lg font-medium text-gray-700">
      <div className="flex justify-between">
        ...
        <Image className="cursor-pointer" src={`/icons/${isDetail ? 'Up' : 'Down'}.svg`} alt="아이콘" width={20} height={20} onClick={() => setIsDetail(!isDetail)} />
      </div>
      <div>
        <Image src={selectedPart.image} alt={selectedPart.name} width={380} height={200} className="aspect-video" />
      </div>
