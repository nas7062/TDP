...
export default function ViewButtons({ moveCameraToView, setIsMoveCamera }: Props) {
  return (
    <Dialog modal={false}>
      ...
      <DialogContent
        className="sm:max-w-xs flex flex-col gap-4 bg-white px-6 py-5 shadow-[0_18px_45px_rgba(0,0,0,0.12)] left-[23%]  top-[unset] bottom-[-100px] w-[198px]"
        onInteractOutside={(e) => e.preventDefault()}
      >
        <DialogHeader className=" relative">
          <DialogTitle className="text-[16px] font-semibold text-gray-900 text-left">
            보기
          </DialogTitle>
        </DialogHeader>
        ...
        <ul className="flex flex-col pl-1">
          <li>
            <button
              ...
              className="flex items-center gap-3 text-[16px] text-gray-700 hover:bg-gray-50 p-2 rounded-md w-[130px]"
            >
