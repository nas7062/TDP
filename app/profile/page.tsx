...
export default function ProfilePage() {
  ...
  return (
    <div className="bg-linear-to-b from-blue-100 via-blue-50 to-white h-screen w-screen flex flex-col justify-around">
      <div className="flex flex-col justify-between w-[467px] h-[292px] mx-auto">
        ...
        {!isLogin && <strong className="text-xl text-black text-center leading-relaxed">
      ...
      {isLogin ? (
        ...
        </div>) : <div className="bg-[#F3F3F3] shadow-lg w-[476px] h-[261px] mx-auto rounded-lg  ">
        <div className="p-12 flex flex-col justify-between h-full">
          <div className="flex w-full flex-col gap-2">
            <label htmlFor="nickname" className="font-medium">닉네임을 입력해주세요</label>
            <input type="text" placeholder="닉네임" className="w-full bg-white px-4 py-2 rounded-lg " name="nickname" />
          </div>
          <div className="mt-auto">
            <button className="w-full bg-gray-800 text-gray-200 py-3 px-6 rounded-lg cursor-pointer">프로필 생성하기 </button>
          </div>
        </div>
      </div>}
